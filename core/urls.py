...
urlpatterns = [
	...
	# -- edit --
	path(r'puzzle/<str:unlockable__hunt__volume_number>/<str:slug>/edit',
		views.PuzzleUpdate.as_view(),
		name='puzzle-update'),
	path(r'solution/<str:puzzle__unlockable__hunt__volume_number>/<str:slug>/edit',
		views.SolutionUpdate.as_view(),
		name='solution-update'),
	path(r'unlockable/<str:hunt__volume_number>/<str:slug>/edit',
		views.UnlockableUpdate.as_view(),
		name='unlockable-update'),
	# -- other --
	path(r'unlock/<str:hunt__volume_number>/<str:slug>',
