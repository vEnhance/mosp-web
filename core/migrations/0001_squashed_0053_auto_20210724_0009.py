...
class Migration(migrations.Migration):
    ...
    replaces = [('core', '0001_initial'), ('core', '0002_auto_20210627_1135'),
    ...
    operations = [
            ...
            fields=[
                ...
                ('name',
                 models.CharField(blank=True,
                                  ...
                                  max_length=80)),
                ('authors',
                 models.CharField(help_text='The credits for this hunt',
                                  max_length=255)),
                ('start_date',
                ...
                ('visible',
                 models.BooleanField(
                     default=False,
                     help_text=
                     "Whether the hunt is visible to people; use false if you're just testing"
                 )),
                ('volume_number',
                 models.CharField(
                     default='I',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question',
                 models.CharField(help_text='The question that the hint is for',
                                  max_length=120)),
                ('answer',
                 models.CharField(help_text='The content of the hint',
                                  max_length=120)),
            ...
            fields=[
                ('uuid',
                 models.UUIDField(default=uuid.uuid4,
                                  ...
                                  serialize=False)),
                ('name',
                 models.CharField(default='Steve',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name',
                 models.CharField(
                     help_text=
                     'The name for this unlockable (e.g. place on map)',
                     max_length=80)),
                ('slug',
                 models.SlugField(help_text='The slug for the unlockable',
                                  unique=True)),
                ('icon',
                 models.CharField(blank=True,
                ...
                ('unlock_needs',
                 models.ForeignKey(
                     blank=True,
                     help_text=
                     'If this is nonempty, then unlock only when the target is done',
                     null=True,
                     on_delete=django.db.models.deletion.SET_NULL,
                ...
                ('sort_order',
                 models.SmallIntegerField(
                     default=50,
                     help_text=
                     'An integer to sort this unlockable by in the listing')),
                ('intro_story_text',
                 models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug',
                 models.SlugField(help_text='The slug for the puzzle',
                                  unique=True)),
                ('content',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=80)),
                ('slug',
                 models.SlugField(help_text='The slug for the round',
                                  unique=True)),
                ('unlockable',
                 models.OneToOneField(
                     blank=True,
            ...
            fields=[
                ('id',
                 models.BigAutoField(auto_created=True,
                                     ...
                                     verbose_name='ID')),
                ('status',
                 models.SmallIntegerField(choices=[(-1, 'Found'),
                                                   (0, 'Unlocked'),
                                                   (1, 'Solved')],
                                          default=-1)),
                ('token',
                 models.ForeignKey(help_text='The token this attempt is for',
                                   on_delete=django.db.models.deletion.CASCADE,
                                   to='core.token')),
                ('unlockable',
        ...
        migrations.AddField(
            ...
            field=models.CharField(default='blargh',
        ...
        migrations.AddField(
            ...
            field=models.PositiveSmallIntegerField(
                choices=[(0, 'Normal user'), (20, 'Testsolver'),
                         (40, 'Bestsolver'), (60, 'Editor'), (80, 'Admin'),
                         (100, 'Evan Chen')],
                default=0,
            ...
            fields=[
                ('id',
                 models.BigAutoField(auto_created=True,
                                     ...
                                     verbose_name='ID')),
                ('display_answer',
                 models.CharField(help_text='Display answer to the puzzle',
                                  max_length=80)),
                ('salt',
                 models.SmallIntegerField(
                ...
                ('message',
                 models.CharField(
                     blank=True,
                     help_text=
                     'For partial answers, the nudge to provide solvers',
                     max_length=256)),
                ('puzzle',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                ...
                ('is_canonical',
                 models.BooleanField(
                     default=True,
                     help_text=
                     'Make this the answer printed by the website for solvers')
                ),
                ('is_correct',
                 models.BooleanField(
                     default=True,
                     help_text=
                     'Make an answer correct; solver marks as correct if seen.')
                ),
            ],
            options={
