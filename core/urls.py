...
urlpatterns = [
    ...
    # -- puzzle --
    path(r'<str:unlockable__hunt__volume_number>/puzzle/<str:slug>',
         views.PuzzleDetail.as_view(),
         name='puzzle-detail'),
    path(r'testsolve/<str:slug>/<str:testsolvesession__uuid>/',
         views.PuzzleDetailTestSolve.as_view(),
         name='puzzle-testsolve'),
    path(r'<str:unlockable__hunt__volume_number>/solution/<str:slug>',
         views.PuzzleSolutionDetail.as_view(),
         kwargs={'cheating': False},
         name='solution-detail'),
    path(r'<str:unlockable__hunt__volume_number>/solution/<str:slug>/spoil',
         views.PuzzleSolutionDetail.as_view(),
    ...
    # -- edit --
    path(r'<str:unlockable__hunt__volume_number>/puzzle/<str:slug>/edit',
